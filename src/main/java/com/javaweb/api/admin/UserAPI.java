...
public class UserAPI {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserDTO> updateUsers(@PathVariable("id") int id, @RequestBody UserDTO userDTO) {
        return ResponseEntity.ok(userService.update((long)id, userDTO));
    }

    @PutMapping("/change-password/{id}")
    public ResponseEntity<String> changePasswordUser(@PathVariable("id") int id, @RequestBody PasswordDTO passwordDTO) {
        try {
    ...
    public ResponseEntity<UserDTO> resetPassword(@PathVariable("id") int id) {
